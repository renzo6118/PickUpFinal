...
String telefonoUsuario = (String) session.getAttribute("telefonoUsuario");
String direccionUsuario = (String) session.getAttribute("direccionUsuario");
%>
...
<div class="dropdown my-auto">
    ...
    <div class="container-fluid page-header py-5">
        <h1 class="text-center text-white display-6">Accede a tu cuenta</h1>
    </div>
    <!-- Single Page Header End -->
        
    <div class="container mt-5">
        <h2 class="text-center">Mis Datos</h2>
        <form action="${pageContext.request.contextPath}/ActualizarDatosServlet" method="post">
            <!-- Nombre -->
            ...
            <div class="form-group mb-3">
                ...
                <input type="email" class="form-control" id="email" name="email" value="${emailUsuario}" readonly>
            </div>

            <!-- Teléfono -->
            <div class="form-group mb-3">
                <label for="telefono">Teléfono</label>
                <input type="text" class="form-control" id="telefono" name="telefono" value="${telefonoUsuario}">
            </div>

            <!-- Dirección -->
            <div class="form-group mb-3">
                <label for="direccion">Dirección</label>
                <input type="text" class="form-control" id="direccion" name="direccion" value="${direccionUsuario}">
            </div>
